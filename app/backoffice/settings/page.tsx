...
import { CheckCircle2, XCircle, Loader2, Mail, Calendar, Key, Webhook, RefreshCw, Send, AlertCircle } from "lucide-react"
      ...
      <main className="flex-1 p-6 space-y-8 max-w-3xl">
        ...
        <section>
          ...
          <div className="space-y-3 opacity-60 pointer-events-none">
            ...
            <IntegrationCard icon={Webhook} name="Webhooks" description="Recibí eventos de formularios y sistemas externos." connected={false} loading={false} />
          </div>
        </section>
      </main>
    </div>
